<x-app-layout>
    ...
    <div class="p-4 sm:ml-64">
        <div class="bg-white dark:bg-gray-800 shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <h1 class="text-2xl font-bold text-center text-black dark:text-white mb-6">Edit Jenis Cuti</h1>
            ...
            <form action="{{ route('admin.jenis_cuti.update', $jenisCuti->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama_cuti" id="nama_cuti" value="{{ old('nama_cuti', $jenisCuti->nama_cuti) }}" 
