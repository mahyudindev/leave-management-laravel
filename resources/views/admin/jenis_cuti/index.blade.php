<x-app-layout>
    ...
    <div class="p-4 sm:ml-64">
        <div class="mb-4">
            <h1 class="text-2xl font-bold text-center text-black dark:text-white">Data Jenis Cuti</h1>
        </div>
                    ...
                    @foreach ($jenisCuti as $index => $cuti)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4 flex space-x-4">
                                <a href="{{ route('admin.jenis_cuti.edit', $cuti->id) }}" class="text-blue-500 hover:underline flex items-center">
                                    <i class="fas fa-edit mr-1"></i>
                                    Edit
                                </a>
                                <form action="{{ route('admin.jenis_cuti.destroy', $cuti->id) }}" method="POST" onsubmit="return confirmDelete(event)" class="inline">
                                    @csrf
                                    @method('DELETE')
