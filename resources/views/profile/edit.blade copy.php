<x-app-layout>
    ...
    <div class="p-4 {{ in_array(auth()->user()->role, ['hrd', 'manager']) ? 'sm:ml-64' : '' }}">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-4">
                <form method="POST" action="{{ route('profile.update') }}" class="space-y-4" onsubmit="return handleFormSubmit(event)">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="tanggal_masuk" name="tanggal_masuk" type="text" value="{{ auth()->user()->tanggal_masuk_kerja }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <input id="tanggal_akhir_kerja" name="tanggal_akhir_kerja" type="text" 
                            value="{{ auth()->user()->tanggal_akhir_kerja ?? 'Kontrak Tetap' }}" 
